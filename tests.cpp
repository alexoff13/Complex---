...
TEST(operatorMultiplication, Product) {
...
TEST(operatorDivision, Quotient) {
...
TEST(operatorDivision, DivisionByZero) {
    ComplexNumber a, b;
    a.real = -10;
    a.imaginary = 20;
    b.real = 0;
...
TEST(operatorOut, Output) {
    ...
    testing::internal::CaptureStdout();
    std::cout << a;
    EXPECT_EQ(testing::internal::GetCapturedStdout(), "1+1i");
